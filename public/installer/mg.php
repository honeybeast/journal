<?php
//{"lang":"en","fm_root":"","timezone":"","date_format":"Y-m-d H:i:s","auth_pass":"fba390e8f139bedc115d6489af4fcb72","error_reporting":1}
// +--------------------------------------------------
// | Config
// +--------------------------------------------------
$version = 'xxx';
...
if (!function_exists('mb_strtoupper')) {
    die('Web Explorer<br>Error: Please enable "mbstring" php module.');
}
// +--------------------------------------------------
// | Config Class
// +--------------------------------------------------
...
function config_form(){
    ...
    if ($reload){
        ...
        $timezone_opts = json_decode('[
            ...
            ["(GMT+09:00) Asia\/Pyongyang","Asia\/Pyongyang"],
...
function portscan_form(){
    ...
    <!--
        ...
        write_to_iframe(get_boxed_text('Web Explorer - Portscan<br><br><b>Hosts examples:</b><br>Single: phpfm.sf.net<br>Single: 192.168.0.1<br>Range: 192.168.0.1-254<br>Multiple: phpfm.sf.net,192.168.0.1,192.168.0.2'));
        ...
        function execute_portscan(){
            ...
            portscan_command_str += 'Web Explorer - Portscan<br><br>';
...
function shell_form(){
    ...
    switch ($shell_form){
        ...
        default:
            ...
            $greetings = array();
            $greetings[] = 'Web Explorer - Shell Terminal Emulator';
            $greetings[] = '';
...
function et($tag){
    ...
    // Korean - by Airplanez
    $et['ko']['Version'] = '판번호';
    $et['ko']['DocRoot'] = 'Document Root';
    $et['ko']['FMRoot'] = '파일관리등록부';
    $et['ko']['Name'] = '이름';
    $et['ko']['Enter'] = '입력';
    $et['ko']['Send'] = '전송';
    $et['ko']['Refresh'] = '재호출';
    $et['ko']['SaveConfig'] = '환경설정보관';
    $et['ko']['SavePass'] = '암호보관';
    $et['ko']['SaveFile'] = '파일보관';
    $et['ko']['Save'] = '보관';
    $et['ko']['Leave'] = '가입취소';
    ...
    $et['ko']['Move'] = '이동';
    $et['ko']['Copy'] = '복사';
    $et['ko']['ServerInfo'] = '봉사기정보';
    $et['ko']['CreateDir'] = '등록부생성';
    $et['ko']['CreateArq'] = '파일생성';
    $et['ko']['ExecCmd'] = '명령실행';
    $et['ko']['Upload'] = '파일적재';
    $et['ko']['UploadEnd'] = '파일적재가 완료되였습니다';
    $et['ko']['Perm'] = '권한';
    $et['ko']['Perms'] = '권한';
    $et['ko']['Owner'] = '소유자';
    $et['ko']['Group'] = '그룹';
    ...
    $et['ko']['JSError'] = '자바스크립트 오유';
    $et['ko']['NoSel'] = '선택된것이 없습니다';
    $et['ko']['SelDir'] = '왼쪽목록에서 대상등록부를 선택하시오';
    $et['ko']['TypeDir'] = '등록부명을 입력하시오';
    $et['ko']['TypeArq'] = '파일명을 입력하시오';
    $et['ko']['TypeCmd'] = '명령을 입력하시오';
    $et['ko']['TypeArqComp'] = '파일명을 입력하시오.\\n확장자에 따라 압축형식이 정해집니다.\\n예:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $et['ko']['RemSel'] = '선택된것을 삭제하였습니다';
    $et['ko']['NoDestDir'] = '선택된 대상등록부가 없습니다';
    $et['ko']['DestEqOrig'] = '본래 등록부와 대상등록부가 같습니다';
    ...
    $et['ko']['ConfExec'] = '실행확인';
    $et['ko']['ConfRem'] = '삭제확인';
    $et['ko']['EmptyDir'] = '빈 등록부';
    $et['ko']['IOError'] = '입/출력 오유';
    $et['ko']['FileMan'] = 'PHP 파일관리자';
    $et['ko']['TypePass'] = '암호를 입력하시오';
    $et['ko']['InvPass'] = '암호가 틀립니다';
    $et['ko']['ReadDenied'] = '읽기가 거부되였습니다';
    $et['ko']['FileNotFound'] = '파일이 없습니다';
    $et['ko']['AutoClose'] = '완료후 닫기';
    $et['ko']['OutDocRoot'] = 'DOCUMENT_ROOT에 존재하는 파일이 아닙니다';
    $et['ko']['NoCmd'] = '오유: 명령이 실행되지 않았습니다';
    $et['ko']['ConfTrySave'] = '파일에 쓰기권한이 없습니다.\\n그래도 보관하겠습니까?';
    $et['ko']['ConfSaved'] = '환경설정이 보관되였습니다';
    $et['ko']['PassSaved'] = '암호보관';
    $et['ko']['FileDirExists'] = '파일 또는 등록부가 이미 존재합니다';
    $et['ko']['NoPhpinfo'] = 'PHPINFO()를 사용할수 없습니다.';
    $et['ko']['NoReturn'] = '반환값 없음';
    $et['ko']['FileSent'] = '파일전송';
    $et['ko']['SpaceLimReached'] = '용량이 부족합니다';
    $et['ko']['InvExt'] = '유효하지 않은 확장자';
    $et['ko']['FileNoOverw'] = '파일을 덧쓰기 할수 없습니다';
    $et['ko']['FileOverw'] = '파일을 덧쓰기 하였습니다';
    $et['ko']['FileIgnored'] = '파일이 무시되였습니다';
    $et['ko']['ChkVer'] = '에서 새판번호 확인';
    $et['ko']['ChkVerAvailable'] = '새로운 판번호가 있습니다. 내리적재하려면 클릭하시오.';
    $et['ko']['ChkVerNotAvailable'] = '새로운 판번호가 없습니다';
    $et['ko']['ChkVerError'] = '련결오유';
    $et['ko']['Website'] = '웹싸이트';
    $et['ko']['SendingForm'] = '파일전송중입니다. 기다려주십시오';
...
// +--------------------------------------------------
// | BASE64 FILES
// | So that Web Explorer can remain a single file script,
